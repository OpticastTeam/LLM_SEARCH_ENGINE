...
def extract_model_names(
    ...
    Args:
        _models_info (Any): Object containing information about available models.
    ...
    # Access models based on attribute style
    try:
        model_names = tuple(model.name for model in _models_info.models)
        logger.info(f"Extracted model names: {model_names}")
        return model_names
    except AttributeError as e:
        logger.error(f"Failed to extract model names: {e}")
        return ()
